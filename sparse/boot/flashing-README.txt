...
Get an Fairphone 5. To be able to replace the Android
system with Sailfish OS, you will need to be able to unlock the bootloader of
your device so that it can be flashed with a new operating system.
...
Make sure that the system language of your Fairphone device is set to English
before you continue.
...
* While holding the 'Volume Down' button, connect the other end of the USB cable
  to your Fairphone device. The LED next to the speaker on the device should
  light up blue.
